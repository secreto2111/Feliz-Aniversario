          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-rose-100 to-pink-100 rounded-2xl p-2">
              <Image
                ...
                className={`w-auto max-w-full h-auto max-h-[85vh] mx-auto object-contain rounded-xl shadow-xl border-4 border-white transition-all duration-300 group-hover:scale-105 ${fadeClass}`}
              />
            </div>
